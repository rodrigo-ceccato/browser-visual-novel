...
export const chapterOne =[
    ...
    displayText: "[--No dia seginte pela manhã--]\n\n [Jogador] Nossa que fome! Quero meu café da manhã! [Jogador] Mas antes tenho que deixar a chave debaixo do tapete."
    },
    ...
    //4
    {
        ...
        displayText: "[Esposa:] O que foi agora?\n[Jogador:] O exterminador veio aqui enquanto eu estive fora?\n\n[Esposa:] Que exterminador?  Você está agindo estranho , esta me assustando ."
    },
    //5
    {
      gameControl: 1,
    ...
    //9
    {
      ...
      displayText: "[Esposa:] Que zumbido? Agora que você falou eu não estou vendo nenhuma mosca mesmo ... \n\n[Jogador:] Onde elas foram? Droga eu vou ligar para o dedetizador. \n\n[Esposa:]  Que dedetizador? \n\n[Jogador:] Um cara que eu achei online, ele já devia estar aqui a essa hora. \n\n[Esposa:] A gente ia sair de manhã! Você ia deixar um estranho sozinho na minha casa? \n\n[Jogador:] Ele estava bem recomendado! Nossa, esse zumbido está me dando dor de cabeça eu não consigo pensar.... \n\n[Esposa:] Não estou ouvido nada. Senta no sofá. Você está muito agitado, ouvindo coisas e sem memória das últimas 3 horas ... Você não acha melhor ir para o médico? "
  },
    //10 Game Over
    {
      gameControl: 1,
      ...
      choices: [new Choice(1, "voltar ao inicio")],
      displayText: "Sua mulher te deixou.\n O zumbido nunca para. Você nunca acha as moscas. Quando você não consegue mais suportar você tem uma ideia. Pega uma faca suja dentro da pia lotada de louça e tenta furar seus tímpanos. Você põe pressão demais na faca e morre. GAME OVER"
  },
    //11 
    {
      gameControl: 1,
      ...
      displayText: "[1 dia depois (Consultório)]\n\n[---- Após o exame ------]\n\n[Médica:] Hummm ... Não parece ter nada errado ... Estranho .... \n\n[Jogador:] Impossível! Eu estou ouvindo um zumbido! Ninguem mais ouve.... Elas só podem estar aí dentro ... \n\n[Médico:] Humm e dês de quando você está ouvindo o zumbido? \n\n[Jogador]Desde antes de ontem ... \n\n[Médico:] E a perda de memória? \n\n[Jogador:] Eu já disse foi logo antes disso\n\n[Médica:] E você tem certeza que não bateu a cabeça ...\n\n[Jogador:]  Eu já disse que tenho!!!!\n\n[Médica:] Hummm você não ingeriu nenhum tipo de alucinógeno?\n\n[Jogador:]Nãooo !!!\n\n[Médica:] Hummm"
  },
    //12
    {
      gameControl: 1,
      ...
      displayText: "[Jogador:]...vou te matar \n\n [Médica:] Senhor ! Controle-se! \n\n[Jogador:] Ahh esse maldito zumbido !!! Me dá um bisturi eu mesmo tiro as moscas dai! \n\n[Médico:]Senhor pelo amor de Deus! Não faça nada estupido! \n\n[Jogador:]Aha achei!!!\n\n[Médico:] Achou o quê ??Meu deus chamem a segurança! "
  },
  //13 game over 
  {
    gameControl: 1,
